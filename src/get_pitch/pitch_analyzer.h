...
namespace upc {
  ...
  private:
    ...
    float RMAX_THRSHLD, ///< Rmax (r[max]/r[0]) threshold for voiced/unvoiced sound
      R1_THRSHLD, ///< R1 (r[1]/r[0]) threshold for voiced/unvoiced sound
      POW_THRSHLD; ///< Power threshold for voiced/unvoiced
